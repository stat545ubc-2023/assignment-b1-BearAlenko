...
```
When I was doing my MDA, many duplicate codes were written. One duplicate code is summarizing the multiple summary statistics across a categorical column. Here I will create a robust function to wrap it up.
```{r}
